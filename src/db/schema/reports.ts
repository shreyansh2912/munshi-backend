...
export const mvProfitLoss = mysqlTable(
    'mv_profit_loss',
    {
        ...
        accountCode: varchar('account_code', { length: 50 }),
        accountName: varchar('account_name', { length: 255 }),
        accountType: mysqlEnum('account_type', ['income', 'expense']).notNull(),
...
export const mvBalanceSheet = mysqlTable(
    'mv_balance_sheet',
    {
        ...
        accountCode: varchar('account_code', { length: 50 }),
        accountName: varchar('account_name', { length: 255 }),
        accountType: mysqlEnum('account_type', ['asset', 'liability', 'equity']).notNull(),
        amount: bigint('amount', { mode: 'number' }).default(0),
...
export const mvArAging = mysqlTable(
    'mv_ar_aging',
    {
        ...
        agingBucket: mysqlEnum('aging_bucket', ['current', '1-30', '31-60', '61-90', '90+']).notNull(),
